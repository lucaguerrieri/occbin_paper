function [ zdata zdataconcatenated oobase_ Mbase_ oostar_ Mstar_ ys_  ] = ...
    solve_one_constraint_temp2(modnam,modnamstar,...
    constraint, constraint_relax,...
    shockssequence,irfshock,nperiods,tol0,maxiter,init_orig,oobase_,Mbase_,oostar_,Mstar_)
