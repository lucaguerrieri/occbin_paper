...
plot([xp(1) xp],[0 cumsum(np*(xp(2)-xp(1)))],'k','LineWidth',2); hold on
plot([xs(1) xs],[0 cumsum(ns*(xs(2)-xs(1)))],'r--','LineWidth',2); 
plot([xl(1)  xl],[0 cumsum(nl*(xl(2)-xl(1)))],'b-.','LineWidth',2); hold off
ylim([0, 1])
...
plot(xp,cumsum(np*(xp(2)-xp(1))),'k','LineWidth',2); hold on
plot(xs,cumsum(ns*(xs(2)-xs(1))),'r--','LineWidth',2); 
plot(xl,cumsum(nl*(xl(2)-xl(1))),'b-.','LineWidth',2); hold off
